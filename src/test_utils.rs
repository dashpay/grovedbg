...
//     // subtree21 has 1 reference under key key211 pointed to
// [subtree1]:subtree12     // (node) subtree32 is empty
...
//         .into(),
//         b"key1211".to_vec(),
//         Node::new_item(b"value1211".to_vec()).with_left_child(b"key1212".
// to_vec()),     );
//     tree.insert(
//         vec![
//             b"subtree1".to_vec(),
...
//         b"key211".to_vec(),
//         Node::new_reference(vec![b"subtree1".to_vec()].into(),
// b"subtree12".to_vec()),     );
...
//         b"sumtree311".to_vec(),
//         Node::new_sumtree(b"key3111".to_vec().into(),
// 10).with_left_child(b"key312".to_vec()),     );
//     tree.insert(
//         vec![b"subtree3".to_vec(), b"subtree31".to_vec()].into(),
//         b"key312".to_vec(),
